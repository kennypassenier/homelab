...
LXC_CLOUDFLARED_IP=${LXC_CLOUDFLARED_IP:-}
LXC_DOWNLOADER_IP=${LXC_DOWNLOADER_IP:-}
LXC_GATEWAY_IP=${LXC_GATEWAY_IP:-}
LXC_MEDIA_IP=${LXC_MEDIA_IP:-}
LXC_MONITORING_IP=${LXC_MONITORING_IP:-}
LXC_PAPERLESS_IP=${LXC_PAPERLESS_IP:-}
LXC_VIKUNJA_IP=${LXC_VIKUNJA_IP:-}
EOF
