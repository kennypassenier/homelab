            ...
            KeyCode::Enter => match state.selected_field {
                ...
                10 => {
                    let config = crate::scaffold::StackConfig {
                        ...
                        cpu_units: state.cpu_units,
                        memory_mb: state.memory_mb,
                        swap_mb: state.swap_mb,
                        disk_gb: state.disk_gb,
                        rootfs_pool: state.rootfs_pool.clone(),
                        host_storage_path: format!("/opt/appdata/{}", state.stack_name),
                        mount_point: "/appdata".to_string(),
                        appdata_backup: state.appdata_backup,
                        appdata_read_only: state.appdata_read_only,
                ...
                2 => match crate::scaffold::read_stack_config(&stack_name) {
                    Ok(config) => {
                        ...
                        app.modal = ActiveModal::StackConfigEditor(StackConfigEditorState {
                            ...
                            ip_mode_v6: config.ip_mode_v6,
                            disk_gb: config.disk_gb,
                            rootfs_pool: config.rootfs_pool,
                            appdata_backup: config.appdata_backup,
                            appdata_read_only: config.appdata_read_only,
