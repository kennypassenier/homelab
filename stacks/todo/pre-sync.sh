...
VIKUNJA_FILES_DIR="/appdata/todo/vikunja-config/files"
VIKUNJA_DB_DIR="/appdata/todo/vikunja-config/db"
...
mkdir -p "$VIKUNJA_CONFIG_DIR" "$VIKUNJA_FILES_DIR" "$VIKUNJA_DB_DIR"
chown -R 1000:1000 "$VIKUNJA_CONFIG_DIR" "$VIKUNJA_FILES_DIR"
chown -R 1000:1000 "$VIKUNJA_DB_DIR"
chmod 0755 "$VIKUNJA_CONFIG_DIR" "$VIKUNJA_FILES_DIR" "$VIKUNJA_DB_DIR"
