...
| F60 | CT 106 was skipped when applying the guards: Jellyfin had a paused session open ("Curiouser and Curiouser"), and restarting docker there would have dropped it | O10's rule applied to my own action rather than only to the scheduler's. Kenny's go was general; he did not know he had a film open | open — needs a quiet moment |
