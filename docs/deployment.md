...
- optional `HOST_LOG_HISTORY_MAX=10000` for in-memory HOST websocket replay retention (default `10000`, clamp `50..10000`)
- optional `LXC_LOG_HISTORY_MAX=10000` for in-memory LXC websocket replay retention (default `10000`, clamp `50..10000`)
- optional `LOG_HISTORY_AGE_SECS=3600` for the age threshold used when counting old HOST/LXC logs toward the cap
